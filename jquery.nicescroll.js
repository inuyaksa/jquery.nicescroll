...
//            self.onmousemove = self.ontouchmove;
                        ...
                        this.checkSelectionScroll = function(e) {
...
//              self.doScrollTop(self.getScrollTop(true)+rt);
                            ...
                            self.debounced("doselectionscroll",function(){this.checkSelectionScroll()},50);
                        }
                        ...
                        self.onselectiondrag = function(e) {
                            if (!self.selectiondrag) return;
                            if (self.hasTextSelected()) self.debounced("selectionscroll",function(){this.checkSelectionScroll(e)},250);
                        }
...
//
            ...
            if (this.doc[0].nodeName == 'IFRAME') {
                ...
                if (this.doc[0].readyState&&this.doc[0].readyState=="complete"){
                    setTimeout(function(){this.oniframeload.call(self.doc[0],false)},500);
                }
                self.bind(this.doc,"load",this.oniframeload);
